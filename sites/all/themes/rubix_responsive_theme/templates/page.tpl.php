...
<div id="header_wrapper">
  <div id="inner_header_wrapper">
    ...
    <?php endif; ?>
      ...
      <?php if ($page['left_header']): ?><div class="header-left-region"><?php print render($page['left_header']); ?></div><?php endif; ?>
      <?php if ($page['right_header']): ?><div class="header-right-region"><?php print render($page['right_header']); ?></div><?php endif; ?>
      <?php endif; ?>
    <div class="clear"></div>
    </header>
    ...
    <div class="menu_wrapper">
      <nav id="main-menu"  role="navigation">
        ...
        <?php if ($page['main_menu']): ?><div class="main-menu-region"><?php print render($page['main_menu']); ?></div><?php endif; ?>
        <div class="clear"></div>
      </nav><!-- end main-menu -->
    </div>
  </div>
