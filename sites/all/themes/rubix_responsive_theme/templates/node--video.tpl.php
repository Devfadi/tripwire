...
<?php
 ...
 if (isset($node->field_enable_lock_icon[LANGUAGE_NONE][0]['value']) && $node->field_enable_lock_icon[LANGUAGE_NONE][0]['value'] == 1 ) :
  ...
  if (isset($node->field_enable_download_video_link[LANGUAGE_NONE][0]['value']) && $node->field_enable_download_video_link[LANGUAGE_NONE][0]['value'] == 1 ) :
    drupal_add_js(array('tripwire' => array('enable_video_link' => 'enabled')), array('type' => 'setting'));
        $class = 'video-link';
 endif;
?>
<?php if (!$page): ?>
